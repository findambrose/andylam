...
contract Voting {
    ...
    //msg.sender comes from the contract
    //address allows writing to/ executing the contract
    address owner;
    ...
    //Delete Contest/ Proposal 
    function deleteProposal(uint candidateID) onlyOwner public {
    ...
    //Edit contestant details
     function editProposal(bytes32 name, bytes32 party) onlyOwner public {
